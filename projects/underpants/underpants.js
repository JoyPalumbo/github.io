...
_.indexOf = function(array, value) {
    //interate over our array and check all of it's value
    for(var i = 0; i < array.length; i++) {
        //o0nce we have access to the elements, check if the value is equal to array[i]
        if(array[i] === value) {
            return i;
        }
...
_.unique = function(array) {
    //loop through array
    // return an array of elements from array with duplicates remove
    let arr = [];
    for(var i = 0; i < array.length; i++) {
...
_.reject = function(array, test) {
    ...
    //for(var i = 0; i < array.length; i++){
//        call test on element, i or key, collection  
 //       if(!test(array[i], i, array)){
//          if test fails test, save it  
//          result.push(array[i]);
   //     }
   // }
  

    //if element does not fail, do nothing
    //after all elements have been checked, return result array
...
_.map = function(collection, test) {
    var arr = [];
     _.each(collection, function(element, index, array) {
       ...
       return arr.push(test(element, index, array));
    });
    return arr;
};
  ...
  let arr = true;
   _.each(collection, function(element, index, array) {
        if(typeof test === 'function' && !test(element, index, collection)) {
            ...
            else if (!element && typeof test !== 'function'){
            arr = false;
            }
